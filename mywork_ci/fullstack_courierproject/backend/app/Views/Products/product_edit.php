              ...
              <?= csrf_field(); ?>
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Enter Product Category Name" name="product_category" value="<?php echo old('product_category') ? old('product_category') : $product['product_category'] ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="file" class="form-control" id="image" placeholder="Enter Product Image" name="product_image" value="">
                    <img src="<?= site_url() . old('product_image') ?  old('product_image') : $product['product_image']?>" style="width: 50px">
                    <span class="text-danger">
                      <?= 
