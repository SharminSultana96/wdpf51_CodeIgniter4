<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="/assets/dist/img/Picture 1.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">Sharmin Sultana</a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('/staffs/new/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Staff</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?= base_url('/branches/new/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>New Branches</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/parcels" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Parcels</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?= base_url('/parcels/new/') ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Parcels</p>
                </a>
              </li>
